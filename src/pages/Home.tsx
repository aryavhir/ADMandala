        ...
        <div className="content-wrapper">
          ...
          <div className="hero-actions-container animate-on-scroll delay-2">
            <div className="decentralization-link-wrapper">
              <Link to="/decentralization" className="explore-button"  style={{ backgroundColor: '#ffffff', color: '#0f4a4a' }}>
            ...
            <Link to="/early-adopters" className="hero-premium-blue-btn">
              <span className="btn-premium-glint"></span>
              <span>Join Our Early Adapters program </span>
